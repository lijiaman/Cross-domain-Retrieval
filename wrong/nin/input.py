...
def load_batchsize_images(batch_size=32):
	...
	shop_batch = []
        ...
        y_shop_batch = []
        y_nopair_batch = []
	with open(tmp+'toy50_train_triplet_category.txt') as f:
...
def load_val_images(batch_size=32):
	...
	shop_batch = []
        ...
        y_shop_batch = []
        y_nopair_batch = []
	with open(tmp+'toy50_val_triplet_category.txt') as f:
		lines = random.sample(f.readlines(),batch_size)
    	#print lines
    	        for line in lines:
    		        line = line.split()
...
def load_test_images(test_batch_size=32):
	...
	shop_batch = []
        ...
        y_shop_batch = []
        y_nopair_batch = []
	with open(tmp+'toy20_test_triplet_category.txt') as f:
